...
org.springframework.cloud.contract.spec.Contract.make {
    ...
    response { // (6)
        ...
        body('''
			   ...
			   "rejectionReason": "To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, "
		},{
			   "fraudCheckStatus": "FRAUD",
			   "rejectionReason": "To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, To long response, "
		},{
